import 'package:todo_app/data_local/models/task/taack_status.dart';
import 'package:todo_app/data_local/models/task/task_model_constants.dart';
...
class TaskModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      TaskModelConstants.status: status.toString(),
